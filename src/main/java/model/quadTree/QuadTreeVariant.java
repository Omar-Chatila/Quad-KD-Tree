...
public abstract class QuadTreeVariant<G extends QuadTreeVariant.XYPoint> {
    ...
    public static void main(String[] args) {
        ...
        PointQuadTree tree2 = new PointQuadTree(new Area(0, 10000, 0, 10000));
        long start2 = System.nanoTime();
        for (Point p : points) {
            tree2.add(p);
        }
        long time2 = (long) ((System.nanoTime() - start2) / 1E6);

        long start1 = System.nanoTime();
        for (Point point : points) {
            tree.insert(point.x(), point.y());
        }
        long time1 = (long) ((System.nanoTime() - start1) / 1E6);

        Area q = new Area(200, 2200, 200, 2200);
        long time345 = System.nanoTime();
        int tally = 0;
        for (Point p : points) {
        ...
        long primTime = (long) ((System.nanoTime() - time345) / 1E6);
        ...
        System.out.println(tree.queryRange(200, 200, 2000, 2000).size());
        long time4 = (long) ((System.nanoTime() - time3) / 1E6);


        System.out.println("His: " + time4);
        System.out.println("My: " + time6);
        System.out.println("Prim: " + primTime);
     ...
     */
    public static class PointRegionQuadTree<P extends QuadTreeVariant.XYPoint> extends QuadTreeVariant<P> {
         ...
         */
        @Override
        public QuadTreeVariant.QuadNode<P> getRoot() {
            return root;
        }
        ...
        protected static class PointRegionQuadNode<XY extends QuadTreeVariant.XYPoint> extends QuadNode<XY> {
     ...
     */
    public static class MxCifQuadTree<B extends QuadTreeVariant.AxisAlignedBoundingBox> extends QuadTreeVariant<B> {
         ...
         */
        @Override
        public QuadTreeVariant.QuadNode<B> getRoot() {
            return root;
        }
        ...
        protected static class MxCifQuadNode<AABB extends QuadTreeVariant.AxisAlignedBoundingBox> extends QuadNode<AABB> {
    ...
    protected static abstract class QuadNode<G extends QuadTreeVariant.XYPoint> implements Comparable<QuadNode<G>> {
        ...
        public int getHeight() {
            ...
            if (isLeaf())
                return 0;
            // Height of the current node is maximum height of its children plus 1
            return Math.max(
                    Math.max(northWest != null ? northWest.getHeight() : 0, northEast != null ? northEast.getHeight() : 0),
                    Math.max(southWest != null ? southWest.getHeight() : 0, southEast != null ? southEast.getHeight() : 0)
            ) + 1;
        }
    ...
    protected static class TreePrinter {
        ...
        public static <T extends XYPoint> String getString(QuadTreeVariant<T> tree) {
